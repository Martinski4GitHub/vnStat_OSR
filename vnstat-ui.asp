...
/**----------------------------------------**/
/** Modified by Martinski W. [2026-Jun-24] **/
/**----------------------------------------**/
...
<td class="settingvalue">
<input autocomplete="off" type="text" maxlength="8" class="input_12_table removespacing" name="dnvnstat_dataallowance" value="1200.00" onkeypress="return validator.isNumberFloat(this, event)" onkeyup="Validate_DataAllowance(this,false)" onblur="Validate_DataAllowance(this,false);Format_DataAllowance(this)" />
&nbsp;<span id="spandefaultallowance" style="color:#FFCC00;">(0: unlimited)</span>
</td>
</tr>
<tr class="even" id="rowallowanceunit">
<td class="settingname">Units for bandwidth allowance</td>
<td class="settingvalue">
...
<input autocomplete="off" type="text" maxlength="2" class="input_3_table removespacing" name="dnvnstat_monthrotate" value="1" onkeypress="return validator.isNumber(this, event)" onkeyup="Validate_AllowanceStartDay(this,false)" onblur="Validate_AllowanceStartDay(this,true)" />
&nbsp;of every month&nbsp;&nbsp;<span style="color:#FFCC00;">(between 1 and 28, default: 1)</span>
</td>
</tr>
...
<td class="settingvalue">
<input type="radio" name="dnvnstat_storagelocation"
   id="dnvnstat_storageloc_jffs" class="input" value="jffs" checked>
<label for="dnvnstat_storageloc_jffs">JFFS</label>
<input type="radio" name="dnvnstat_storagelocation"
   id="dnvnstat_storageloc_usb" class="input" value="usb">
